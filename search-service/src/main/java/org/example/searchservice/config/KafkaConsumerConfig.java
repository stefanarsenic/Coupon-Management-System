...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, Coupon> consumerFactory() {
        return new DefaultKafkaConsumerFactory<>(consumerConfig());
    }

    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, Coupon>> factory (
            ConsumerFactory<String, Coupon> consumerFactory
    ) {
